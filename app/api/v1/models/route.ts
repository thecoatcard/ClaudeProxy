...
export async function GET(req: Request) {
  ...
  return NextResponse.json({
    ...
    data: [
      ...
      { id: "claude-sonnet-4-6", type: "model", display_name: "Claude Sonnet 4.6 (compat)" },
      { id: "claude-sonnet-4", type: "model", display_name: "Claude Sonnet 4.5" },
      { id: "claude-haiku-4",  type: "model", display_name: "Claude Haiku 4.5" },
      { id: "claude-haiku",  type: "model", display_name: "Claude Haiku 4.5" },
      { id: "claude-3-7-sonnet", type: "model", display_name: "Claude 3.7 Sonnet (compat)" },
      { id: "claude-3-5-sonnet", type: "model", display_name: "Claude 3.5 Sonnet (compat)" },
      { id: "claude-3-opus", type: "model", display_name: "Claude 3 Opus (compat)" },
      { id: "claude-3-haiku", type: "model", display_name: "Claude 3 Haiku (compat)" },
